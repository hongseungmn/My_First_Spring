    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                ...
                <li><a href="<c:url value="Model.do"/>" class="nav-link px-2 text-secondary">Machine-Learning</a></li>
            </ul>
            <div class="text-end">
                ...
                <c:if test="${not empty UserId}">
                    <button type="button" class="btn btn-outline-light me-2" data-backdrop="static" onclick="location.href='/MyPage.do'">${UserId}</button>
